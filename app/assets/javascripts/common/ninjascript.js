...
ninjascript.sizzle = function() {
  ...
  l.find = function(h, a, b) {
    ...
    for(var e = 0, f = k.order.length;e < f;e++) {
      ...
      if(d = k.leftMatch[g].exec(h)) {
        var s = d[1];
        d.splice(1, 1);
        if("\\" !== s.substr(s.length - 1) && (d[1] = (d[1] || "").replace(/\\/g, ""), c = k.find[g](d, a, b), null != c)) {
  ...
  l.filter = function(h, a, b, c) {
    for(var d = h, e = [], f = a, g, s, q = a && a[0] && v(a[0]);h && a.length;) {
      for(var m in k.filter) {
        if(null != (g = k.leftMatch[m].exec(h)) && g[2]) {
          ...
          if("\\" !== r.substr(r.length - 1)) {
            f === e && (e = []);
            if(k.preFilter[m]) {
              if(g = k.preFilter[m](g, f, b, e, c, q), !g) {
                s = t = !0
              }else {
                if(!0 === g) {
                  continue
            ...
            if(g) {
              for(var x = 0;null != (r = f[x]);x++) {
                if(r) {
                  t = w(r, g, x, f);
                  var u = c ^ !!t;
                  b && null != t ? u ? s = !0 : f[x] = !1 : u && (e.push(r), s = !0)
                }
              }
            }
            if(void 0 !== t) {
  ...
  leftMatch:{}, attrMap:{"class":"className", "for":"htmlFor"}, attrHandle:{href:function(h) {
    ...
    if("string" === typeof b && !/\W/.test(b)) {
      var s = b = b.toLowerCase(), k = f
    }
    k("parentNode", b, g, a, s, e)
  }, "~":function(a, b, e) {
    var g = d++, k = c;
    if("string" === typeof b && !/\W/.test(b)) {
      var s = b = b.toLowerCase(), k = f
    }
    k("previousSibling", b, g, a, s, e)
